...
public class AuditTrailAspect {
    ...
    @AfterReturning(pointcut = "execution(* ppl.momofin.momofinbackend.service.DocumentService.submitDocument(..))", returning = "document")
    public void logDocumentSubmitReturn(JoinPoint joinPoint, Document document) {
        logActivity(joinPoint, document, "SUBMIT");
    }
